        ...
        switch (noOfGraphs) {
            case 1:
                ...
                for( Integer i =0 ;i < graph1.size(); i++) {
                    ...
                    seriesData.add(new DebtGraphFragment.CustomDataEntry(g1.getYear(),g1.getValue() ));
                }
                break;
            case 2:
                graph1 = rawData.get("graph1");
                ...
                for( Integer i =0 ;i < graph1.size(); i++) {
                    ...
                    seriesData.add(new DebtGraphFragment.CustomDataEntry(g1.getYear(),g1.getValue() , g2.getValue() ));
                }
            ...
            case 3:
                ...
                for( Integer i =0 ;i < graph1.size(); i++) {
                    ...
                    seriesData.add(new DebtGraphFragment.CustomDataEntry(g1.getYear(),
                            g1.getValue() ,
                            g2.getValue(),
                            g3.getValue()));
                }
